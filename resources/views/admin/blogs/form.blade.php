...
<div class="page-header">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.blogs') }}">{{trans('index.Blogs')}}</a></li>
    <li class="breadcrumb-item active">{{trans('index.Add')}}</li>
  </ol>
  <h1 class="page-title">{{trans('index.AddBlog')}}</h1>
</div>
    ...
    <form method="POST" action="{{ route('admin.saveBlog') }}" id="blogForm" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-7">
          <label class="form-control-label">{{trans('index.BlogTitle')}} <span class="required">*</span></label>
      ...
      <div class="row">
            <div class="form-group col-md-7">
                <label class="form-control-label">{{trans('index.Description')}}</label>
            ...
            <div class="form-group col-md-5">
                <label class="form-control-label">{{trans('index.Blog Image')}}</label>
      ...
      <div class="form-group row">
        <div class="col-md-4">
          <button type="submit" class="btn btn-primary">{{trans('index.Submit')}}</button>
          <button type="reset" class="btn btn-default btn-outline">{{trans('index.Reset')}}</button>
        </div>
      </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">{{trans('index.EditPhoto')}}</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="cropImageBtn" class="btn btn-primary">{{trans('index.Crop')}}</button>
            </div>
        </div>
    </div>
</div>
