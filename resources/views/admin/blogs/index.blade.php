...
<div class="page-header">
  ...
  <h1 class="page-title">{{trans('index.Blogs')}}</h1>
</div>
...
<div class="panel">
        <div class="panel-heading">
            <div class="panel-title">
              <a href="{{ route('admin.blogForm') }}" class="btn btn-success btn-sm"><i class="icon wb-plus" aria-hidden="true"></i>{{trans('index.AddBlog')}}</a>
            </div>
          
          <div class="panel-actions">
          <form method="GET" action="{{ route('admin.blogs') }}">
              <div class="input-group">
                <input type="text" class="form-control" name="search" placeholder="{{trans('index.Search')}}" value="{{ Request::input('search') }}">
