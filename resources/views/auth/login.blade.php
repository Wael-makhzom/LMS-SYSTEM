    ...
    <div class="container-fluid p-0 home-content container-top-border">
        ...
        <div class="container">
            <nav class="navbar clearfix secondary-nav pt-0 pb-0 login-page-seperator">
                <ul class="list mt-0">
                     <li><a href="{{ route('login') }}" class="active">{{trans('index.Login')}}</a></li>
                     <li><a href="{{ route('register') }}">{{trans('index.Register')}}</a></li>
                </ul>
            </nav>
                    ...
                    <form id="loginForm" class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="p-4">
                            <div class="form-group">
                                ...
                                <input name="email" type="text" class="form-control form-control-sm" placeholder="{{trans('index.EmailID')}}" value="{{ old('email') }}">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group">
                                ...
                                <input name="password" type="password" class="form-control form-control-sm" placeholder="{{trans('index.Password')}}" value="{{ old('password') }}">
                            ...
                            <div class="form-group">
                                <div class="row m-0">
                                    <div class="custom-control custom-checkbox col-6">
                                        ...
                                        <label class="custom-control-label" for="remember">{{trans('index.Rememberme')}}</label>
                                    </div>
                                    <div class="col-6">
                                        <a href="{{ route('password.request') }}" class="float-right forgot-text">{{trans('index.Forgotpassword?')}}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-lg btn-block login-page-button">{{trans('index.Login')}}</button>
                            </div>

                            <div class="hr-container">
                               <hr class="hr-inline" align="left">
                               <span class="hr-text"> {{trans('index.or')}} </span>
                            ...
                            <div class="form-group">
                                <a href="{{ url('login/google') }}" class="btn btn-lg btn-block social-btn google-btn">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <span>
                                             {{trans('index.LoginwithGoogleplus')}}     
