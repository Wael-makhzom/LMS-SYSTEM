        ...
        <div class="container">
            <nav class="navbar clearfix secondary-nav pt-0 pb-0 login-page-seperator">
                <ul class="list mt-0">
                     ...
                     <li><a href="{{ route('register') }}" class="active">{{trans('index.Register')}}</a></li>
                </ul>
            </nav>
                ...
                <div class="col-xl-6 offset-xl-0 col-lg-6 offset-lg-0 col-md-8 offset-md-2">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}" id="registerForm">
                        ...
                        <div class="p-4">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm" placeholder="{{trans('index.FirstName')}}" value="@if(!empty($name)){{ $name }}@else{{ old('first_name') }}@endif" name="first_name"   >
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm" placeholder="{{trans('index.LastName')}}" value="{{ old('last_name') }}" name="last_name">
                            ...
                            <div class="form-group">
                                <label>{{trans('index.EmailID')}}</label>
                                <input type="text" class="form-control form-control-sm" placeholder="{{trans('index.EmailID')}}" value="@if(!empty($name)){{ $email }}@else{{ old('email') }}@endif" name="email">
                                 @if ($errors->has('email'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control form-control-sm" placeholder="{{trans('index.Password')}}" name="password" id="password">
                            ...
                            <div class="form-group">
                                <label>{{trans('index.ConfirmPassword')}}</label>
                                <input type="password" class="form-control form-control-sm" placeholder="{{trans('index.ConfirmPassword')}}" name="password_confirmation">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="offer">{{trans('index.Receiverelevant')}}</label>
                                </div>
                            </div>

                            <div class="form-group mt-4">
                                <button type="submit" class="btn btn-lg btn-block login-page-button">{{trans('index.Register')}}</button>
                            </div>
